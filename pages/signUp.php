...
<body>
    <div class='h-screen w-full flex justify-center items-center bg-neutral-900 text-neutral-200'>
        <div class='w-1/4 border-2 py-10 px-5 rounded-3xl'>
            <h1 class='uppercase text-center text-3xl font-bold tracking-wider my-3'>rejestracja</h1>
            <form action="includes/signInHandle.php" method="post" class='flex flex-col'>
                <div class='flex flex-col my-3'>
                    <label for="username" class='mb-1 capitalize'>username</label>
                ...
                <div class='flex flex-col my-3' >
                    <label for="password" class='mb-1 capitalize'>password</label>
